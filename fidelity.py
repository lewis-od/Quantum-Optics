...
from quoptics.states import cat, squeezed_cat, zombie, cubic_phase, on_state, random_states, to_numpy
...
FOCK_SPACE = [to_numpy(basis(T, n)) for n in np.linspace(0, T-1, T, dtype=int)]
